...
def generate_combined_report():
    ...
    # Criar e escrever o relatório em um arquivo .txt com o nome incluindo a data
    report_file_name = '/Users/sgtvale/Desktop/DEV/Contador de Impressões/Contadores/relatorio_{}.txt'.format(today)
    with open(report_file_name, 'w') as report_file:
        report_file.write(report_message)

# Chamar a função para gerar o relatório combinado
